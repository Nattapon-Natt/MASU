...
//     const handleToStep2 = async (e) => {
//       e.preventDefault();
//       if (regisUrl === 'none') {
//         Swal.fire('Error', 'กรุณาเลือกประเภทสมาชิก', 'error');
//         return;
//       }
//       if (!validateTel(tel)) {
//         Swal.fire('Error', 'กรุณาใส่เบอร์โทรให้ถูกต้อง', 'error');
//         return;
//       }
//       try {
//         const response = await axios.post('/register/reqotp', { tel, type: regisUrl });
//         if (response.data.status === 'success') {
//           Swal.fire('Success', 'ส่งข้อความเรียบร้อยแล้ว', 'success');
//           setStep(2);
//         } else {
...
//     const validateTel = (inputStr) => /^\d{10}$/.test(inputStr);
...
//             const { data } = await axios.post('/register/reqotp', { tel, token, type: regisUrl });
...
//                 tel, username, password, password2, firstname, lastname, lineId, token
//             });
...
//                                                 <button className="btn btn-idol round btn-lg" onClick={handleToStep2}>
//                                                     ดำเนินการต่อ
//                                                 </button>
//                                             </div>
//                                         </div>
